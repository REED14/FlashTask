window.onload = function(){
    ...
    var fdiv2 = document.getElementById("fdiv2");
    var divform = document.getElementById("fdiv");
    var wd = document.getElementById("worker_data");
    ...
    function fetch_data(position){
        ...
        var PosY=position.coords.longitude;
            $.ajax({
                ...
                method: "POST",
                dataType: 'json',
                data : {"userPosX": PosX, "userPosY": PosY},
                success : function(data){
                    ...
                    switch(chore_state){
                        case "0":
                            ...
                            statusname.innerHTML =  "<a>Searching for a Worker</a>";
                        ...
                        case "1":
                            ...
                            wd.innerHTML = "<a style='color:black; font-size:20px; font-family: Arial, Helvetica, sans-serif;'>Worker Email: " + data['email'] + "</a><br><a style='color:black; font-size:20px; font-family: Arial, Helvetica, sans-serif;'>Worker Phone Number: " + data['phone'] + "</a>";
                        ...
                        case "3":
                            ...
                            //window.location.href='chores-type.php';
                            setTimeout(function(){
                                window.location.href='chores-type.php';
                            }, 3000);
                            wd.style.display = "none";
    ...
    switch(chore_state){
        case 0:
            ...
            icondiv.style.marginBottom = "100px";
            bardiv.innerHTML = '<div class="in-progress"><div class="percent"></div></div><div class="unstarted"> </div> <div class="unstarted"> </div>'
            statusname.innerHTML =  "<a>Searching Worker</a>";
            console.log("gay");
            break;
        default:
            console.log("gay");
