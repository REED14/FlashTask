...
<body>
    ...
    <form method="post" action="server-scripts/change_loc_w.php">
        <div style="border-bottom: 2px solid gray; width:80%; margin: auto;">
            <?php

                require("server-scripts/connect_db.php");

                $query = "SELECT * FROM `location_worker` WHERE `email`='". $_SESSION['wemail'] ."'";
    ...
    <div id="addloc">
        ...
        <div id = "location">
            <form method="post" action="server-scripts/add_loc_w.php">
                <a>Add Location</a>
