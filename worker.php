<?php
    $login_zone=0;
    if($_SERVER['REQUEST_METHOD']=="POST" || isset($_COOKIE['loginCookieW']))
    {
        require("server-scripts/register_worker.php");
        require("server-scripts/login_worker.php");
    }
    else{
        session_start();
...
<head>
    ...
    <title>FlashTask | For Workers</title>
...
<body>
    ...
    <div class="page-head">
        ...
        <div class="inside-head">
            <div class="name_and_logo">
                ...
                <h1 style="text-align:center">FlashTask - worker</h1>
            </div>
        </div>

        <div class="app_description">
            <a>FlashTask for Workers is an app that connects you(the worker) to the peolple that need your help when it comes to solving their chores.
            </a>
        </div>
    ...
    <div id="logsign">
        ...
        <div  class="info_commission">
            <a>You will get paid by the people that you help with the chores and we will get 15% of the revenue as a commission.</a>
            <a style="color:red">Before you Sign Up you have to create a Stripe account!</a>
        </div>
        <?php
            $login_zone = 1;
            require("server-scripts/register_worker.php");
    ...
    <div id="register_form">
        <form method="post">
            ...
            <input type="hidden" name="workReg">
    ...
    <div id="login_form">
        <form method="post">
            ...
            <input type="hidden" name="wrkLogin">
